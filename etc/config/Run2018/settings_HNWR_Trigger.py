...
baseOutDir = 'results/Trigger/2018/'
...
samplesDef = {
    'data'   : tnpSamples.Temp2018Sample['2018DATA'].clone(),
    'mcNom'  : tnpSamples.Temp2018Sample['2018DYLO1'].clone(),
    'mcAlt'  : tnpSamples.Temp2018Sample['2018DYNLO1'].clone(),
    'tagSel' : tnpSamples.Temp2018Sample['2018DYLO2'].clone(),
}
...
#############################################################
### cut
cutBase   = 'tag_Ele_pt > 35 && passingHEEP'
